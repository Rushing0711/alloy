...
**Goal:** 创建一个完整的用户手册，涵盖 CLI 命令使用、AI Agent 工作流、配置参考和故障排除。

**Architecture:** 单文件用户手册 `docs/user-guide.md`，包含 5 个主要章节：快速开始、CLI 命令参考、AI Agent 工作流、配置参考、故障排除。
