...
| `must-read-before-development.md` | **Skill 编写经验** | 来自 skill-creator、writing-skills、Comet、Claude Code 官方文档的编写规范和最佳实践 |

**阅读顺序：** 写代码前必读 `must-read-before-development.md`；设计参考 `alloy-design.md` → `hybrid-workflow.md` → `hybird.md`。
...
### Skill 开发参考
- **开发前必读：** `must-read-before-development.md`（Skill 编写规范和最佳实践）
